...
inv <tx|block> <hash> - Announces to peers that you have a block or transaction with the specified hash. getdata <tx|block> <hash> - Requests a specific block or transaction from peers by hash.
